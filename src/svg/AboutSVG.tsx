export function AboutSVG({ className }: { className?: string }) {
    return (
        <svg
            className={className}
            width="24"
        ...
        >
            ...
            />
            <path d="M12.5 9H8" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M15.5 11.5H7.5" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M15 14H7" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M11.5 16.5H7" strokeWidth="1.5" strokeLinecap="round" />
