        ...
        <div className="flex flex-col justify-between w-full h-full items-center " >
            <div className="flex flex-col gap-8 max-w-96 m-auto">
                ...
                <div className="flex flex-col gap-4">
                    <Link href="/account/sign-up" className="w-full bg-[var(--primary)] text-center p-4 rounded-2xl font-bold text-white text-[16px]">
                        Create an account
                    </Link>
                    <Link href="/account/sign-in" className="w-full bg-[var(--primary-light)] text-center p-4 rounded-2xl font-bold text-[var(--primary)] text-[16px]">
                        Login
                    </Link>
                </div>
            </div>
